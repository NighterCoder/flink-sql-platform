...
//    }
  ...
  protected static AttributedString formatCommand(SqlCommandParserV2.SqlCommand cmd, String description) {
...
//  public abstract boolean executeMultipleInsertInto(String jobName, Object tblEnv, InterpreterContext context) throws Exception;
  ...
  public abstract Optional<SqlCommandParserV2.SqlCommandCall> parseSql(Object tableEnv, String stmt);
